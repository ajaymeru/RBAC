...
const UserDetails = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BASICURL}/api/admin/users/${id}`, {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`${import.meta.env.VITE_BASICURL}/api/admin/users/${id}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
  ...
  const handleSaveChanges = async () => {
    try {
      await axios.put(
        `${import.meta.env.VITE_BASICURL}/api/admin/users/${id}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
