...
const Users = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BASICURL}/api/admin/users`, {
          headers: {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`${import.meta.env.VITE_BASICURL}/api/admin/users/${deleteUserId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      });
